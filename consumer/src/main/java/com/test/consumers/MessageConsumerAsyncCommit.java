...
public class MessageConsumerAsyncCommit {
	...
	public MessageConsumerAsyncCommit(Map<String, Object> propsMap) {
	...
	public static void main(String[] args) {
		MessageConsumerAsyncCommit messageConsumer = new MessageConsumerAsyncCommit(buildConsumerProperties());
